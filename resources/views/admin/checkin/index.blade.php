...
<div class="space-y-5">
    ...
    <div class="flex items-center gap-3 bg-red-50 border border-red-200 rounded-2xl px-5 py-4">
        ...
        <div>
            ...
            <p class="text-xs text-red-600 mt-0.5">Tiada semak masuk baru boleh dilakukan. <a href="{{ route('admin.checkin.dashboard') }}" class="underline font-bold hover:text-red-800">Pergi ke Papan Pemuka untuk buka kunci.</a></p>
        </div>
    </div>
    @endif
