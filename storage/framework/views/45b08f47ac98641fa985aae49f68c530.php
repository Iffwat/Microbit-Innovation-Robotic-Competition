<!DOCTYPE html>
<html lang="<?php echo e(app()->getLocale()); ?>" data-theme="MIRC">
<head>
    <meta charset="UTF-8">
    ...
    <div class="w-full max-w-sm relative animate-slide-up">
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8">
            ...
            <div class="mt-6 pt-5 border-t border-base-200 text-center">
                <a href="<?php echo e(route('semakan')); ?>" class="text-xs text-base-content/40 hover:text-primary transition-colors">
...
<?php /**PATH C:\laragon\ElviraSdnBhd\Tournament-Management-System\resources\views/admin/login.blade.php ENDPATH**/ ?>