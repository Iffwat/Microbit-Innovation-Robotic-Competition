...
<body class="bg-base-200 min-h-screen flex flex-col">
    ...
    <footer class="bg-white border-t border-base-200 py-5 text-center text-xs text-base-content/40">
        <p class="font-medium">� <?php echo e(date('Y')); ?> Microbit Innovation Robotic Competition</p>
...
<?php /**PATH C:\laragon\ElviraSdnBhd\Tournament-Management-System\resources\views/layouts/public.blade.php ENDPATH**/ ?>