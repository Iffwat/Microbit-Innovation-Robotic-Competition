...
<div class="space-y-6 animate-slide-up">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white border border-base-200 rounded-3xl p-6 shadow-sm">
        <div>
            <h1 class="text-2xl font-black text-base-content">🏆 <?php echo e(__('Pengurusan Kalah Mati')); ?></h1>
            <p class="text-sm text-base-content/60 mt-1"><?php echo e(__('Jana dan pantau carta pusingan kalah mati (Knockout Brackets) selepas tamat peringkat kumpulan.')); ?></p>
        </div>
    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasGroups): ?>
                        <div class="space-y-2 mt-4">
                            <div class="flex justify-between items-center bg-base-50 px-4 py-2 rounded-xl text-sm">
                                <span class="text-base-content/60 font-medium"><?php echo e(__('Jumlah Kumpulan:')); ?></span>
                                <span class="font-bold text-base-content"><?php echo e($groups->count()); ?> (<?php echo e($groups->pluck('group_letter')->join(', ')); ?>)</span>
                            </div>
                            <div class="flex justify-between items-center bg-base-50 px-4 py-2 rounded-xl text-sm">
                                <span class="text-base-content/60 font-medium"><?php echo e(__('Status Kalah Mati:')); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasKnockouts): ?>
                                    <span class="font-bold text-primary"><?php echo e(__('Telah Dijana')); ?></span>
                                <?php else: ?>
                                    <span class="font-bold text-amber-500"><?php echo e(__('Belum Dijana')); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    <?php else: ?>
                        <p class="text-sm text-base-content/50 mt-4 italic"><?php echo e(__('Kategori ini tidak mempunyai peringkat liga/kumpulan.')); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>

                <div class="p-4 bg-base-50 border-t border-base-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasGroups): ?>
                        <button class="w-full bg-base-200 text-base-content/40 font-bold py-2.5 rounded-xl cursor-not-allowed text-sm"><?php echo e(__('Tiada Sokongan')); ?></button>
                    <?php elseif($hasKnockouts): ?>
                        <div class="flex gap-2">
                            ...
                            <button wire:click="selectCategory(<?php echo e($category->id); ?>)" class="px-3 bg-base-200 hover:bg-primary/10 hover:text-primary text-base-content/60 font-bold rounded-xl transition-colors text-sm" title="<?php echo e(__('Jana Semula')); ?>">
                            ...
                            <button wire:click="deleteKnockout(<?php echo e($category->id); ?>)" 
                                    ...
                                    class="px-3 bg-base-200 hover:bg-red-100 hover:text-red-600 text-base-content/60 font-bold rounded-xl transition-colors text-sm" title="<?php echo e(__('Padam Kalah Mati')); ?>">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <div class="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden animate-slide-up">
                <div class="p-6 border-b border-base-200 bg-base-50">
                    <h3 class="font-black text-xl text-base-content"><?php echo e(__('Jana Perlawanan:')); ?> <?php echo e($cat->name); ?></h3>
                </div>
                
                <div class="p-6 space-y-6">
                    <div class="bg-blue-50 border border-blue-200 text-blue-800 p-4 rounded-2xl text-sm leading-relaxed">
                        <?php echo e(__('Kategori ini mempunyai')); ?> <strong><?php echo e($groupCount); ?> <?php echo e(__('Kumpulan')); ?></strong>. <?php echo e(__('Sistem akan menyusun perlawanan secara silang (Piawaian FIFA) berdasarkan kedudukan terkini peringkat kumpulan.')); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasKnockouts): ?>
                        <div class="bg-red-50 border border-red-200 text-red-700 p-4 rounded-2xl text-sm font-medium flex items-start gap-3">
                            ...
                            <?php echo e(__('AMARAN: Data kalah mati (beserta skor) yang sedia ada untuk kategori ini akan dipadam dan dijana semula secara automatik jika anda meneruskan.')); ?>
                    ...
                    <div class="space-y-3">
                        <button wire:click="generateKnockout(<?php echo e($cat->id); ?>, false)" class="w-full bg-primary hover:bg-primary/90 text-white font-bold py-4 rounded-2xl shadow-lg shadow-primary/20 transition-all flex flex-col items-center justify-center gap-1">
                            <span><?php echo e(__('Jana Pusingan Trofi Sahaja')); ?></span>
                            <span class="text-xs font-medium text-white/70">(<?php echo e(__('Juara & Naib Juara Kumpulan sahaja')); ?>)</span>
                        </button>
                        ...
                        <button wire:click="generateKnockout(<?php echo e($cat->id); ?>, true)" class="w-full bg-secondary hover:bg-secondary/90 text-white font-bold py-4 rounded-2xl shadow-lg shadow-secondary/20 transition-all flex flex-col items-center justify-center gap-1">
                            <span><?php echo e(__('Jana Trofi & Piala (Khas U12)')); ?></span>
                            <span class="text-xs font-medium text-white/70">(<?php echo e(__('Trofi: Top 2 | Piala: Tempat 3 & 4')); ?>)</span>
                        </button>
                        ...
                        <button wire:click="deleteKnockout(<?php echo e($cat->id); ?>)" 
                            ...
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg>
                            <span><?php echo e(__('Padam Carta Kalah Mati Sedia Ada')); ?></span>
                        </button>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
